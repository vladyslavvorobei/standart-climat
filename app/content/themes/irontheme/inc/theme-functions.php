...
if ( ! function_exists( 'ith_setup' ) ) :
  ...
  function ith_setup() {
    ...
    add_image_size( 'portfolio', 690, 460, true );
  }
endif;
...
function ith_scripts() {
  ...
  wp_enqueue_style( 'ith-fancybox-style', 'https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.css' );
  wp_enqueue_style( 'ith-main-style', get_template_directory_uri() . '/css/app.css' );

  wp_enqueue_script( 'ith-main', get_template_directory_uri() . '/js/app.js', array(), '', true);
  wp_enqueue_script( 'ith-test', get_template_directory_uri() . '/js/test.js', array(), '', true);
